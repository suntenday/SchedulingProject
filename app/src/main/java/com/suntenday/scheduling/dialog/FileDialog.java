package com.suntenday.scheduling.dialog;
...
public class FileDialog {
    public static String tag = "FileDialog";
    ...
    public static Dialog createDialog(int id, Context context, String title, FileDialogCallbackListener callback, String suffix, Map<String, Integer> images){
    ...
    static class FileSelectView extends ListView implements OnItemClickListener{
        ...
        private FileDialogCallbackListener callback = null;
        ...
        public FileSelectView(Context context, int dialogid, FileDialogCallbackListener callback, String suffix, Map<String, Integer> images) {
            super(context);
        ...
        private int refreshFileList()
        {
            ...
            SimpleAdapter adapter = new SimpleAdapter(getContext(), list, R.layout.dialog_file, new String[]{"img", "name", "path"}, new int[]{R.id.dialog_file_img, R.id.dialog_file_name, R.id.dialog_file_path});
    ...
    // 简单的Bundle参数回调接口  
    public interface FileDialogCallbackListener {
